...
public class IntakeSubsystem extends SubsystemBase {
  ...
  private final TalonFX leader = new TalonFX(8);
  ...
  public void runIntake() {
    m_velocity.Slot = 0;
    leader.setControl(m_velocity.withVelocity(Constants.INTAKE_RAD_PER_MIN));
  }

  public void reverseIntake() {
    m_velocity.Slot = 0;
    leader.setControl(m_velocity.withVelocity(Constants.REVERSE_INTAKE_RAD_PER_MIN));
  }
  ...
  public double getWheelVelocity() {
    return leader.getVelocity().getValueAsDouble() * Constants.WHEEL_CIRCUMFRANCE;
  }
