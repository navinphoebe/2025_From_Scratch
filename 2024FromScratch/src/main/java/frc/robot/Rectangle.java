...
public class Rectangle {
    ...
    public static boolean isNoteInIndexerBox() {
        double noteX = NoteVisualizer.notePosition.getX() - Constants.TILTED_NOTE_RADIUS;
        if (noteX < Constants.INDEX_SENSOR_MAX && noteX > Constants.INDEX_SENSOR_MIN) {
            return true;
        }
        return false;
    }
